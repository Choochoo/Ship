...
namespace Ship.Game.Beans.Mortals.Keys
{
    ...
    {
        public static readonly Dictionary<string, byte> TypesOfTerrain = new Dictionary<string, byte> { { GrassString, Grass }, { DirtString, Dirt }, { SandString, Sand }, { WallString, Wall }, { RiverWaterString, RiverWater }, {OceanWaterString, OceanWater} };
