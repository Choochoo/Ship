...
namespace Ship.Game.Play.WorldGeneration.WorldDrawing
{
    public class ForestGenerator : MapBase
    {
        ...
        private void CheckColor(int x, int y, byte color)
        {
            ...
            //if (WorldData.MyWorldData.TempData[x][y] == TemperatureGenerator.Frozen) return;

            //if (WorldData.MyWorldData.TempData[x][y] == TemperatureGenerator.Hot)
            //{
            ...
            //else
            //{
                //if (WorldData.MyWorldData.TempData[x][y] == TemperatureGenerator.Warm)
                //{
                //    if (color == Medium)
                //        color = Dense;
                //    if (color == Light)
