...
namespace Ship.Game.Play.Utils
{
    public static class Utility
    {
        ...
        public static void TimeStart() { _timestart = Environment.TickCount; }

        public static void TimeEnd() { System.Diagnostics.Debug.WriteLine("Timer Ended: {0}", (Environment.TickCount - _timestart)); }
