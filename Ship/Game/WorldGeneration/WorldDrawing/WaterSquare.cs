...
namespace Ship.Game.WorldGeneration.WorldDrawing
{
    ...
    public class WaterSquare
    {
        ...
        [NonSerialized]
        public const byte AdjescentNone = 5;
        [NonSerialized]
        public const byte AdjescentTop = 6;
        [NonSerialized]
        public const byte AdjescentBottom = 7;
        [NonSerialized]
        public const byte AdjescentLeft = 8;
        [NonSerialized]
        public const byte AdjescentRight = 9;
